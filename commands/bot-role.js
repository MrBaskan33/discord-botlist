...
module.exports = {
  ...
  data: new Discord.SlashCommandBuilder()    
    ...
    .setDescription("Set/reset the a bot role")
    .setDescriptionLocalizations({
      "tr": "Bot rolünü ayarlar/sıfırlar.",
    })
    ...
    .addSubcommand((command) =>
      command
        ...
        .setDescription('Set a bot role.')
        .setDescriptionLocalizations({
           "tr": "Bot rolünü ayarlar.",
         }) 
   ...
   .addSubcommand((command) =>
     command
       ...
       .setDescription('Reset a bot role.')
       .setDescriptionLocalizations({
         "tr": "Bot rolünü sıfırlar.",
       })),
      ...
      case "set": {
        ...
        if(botRole) {
         ...
         const alreadyRole = new Discord.EmbedBuilder()
            .setColor("Red")
            .setAuthor({name: interaction.user.username, iconURL: interaction.user.avatarURL()}) 
            .setDescription(`${emojis["cross"]} ${(locales[interaction.loacale] ?? locales[settings.defaultLang])["already-role"].replace(/\{role}/g, botRole)}`)
            .setFooter({text: client.user.username, iconURL: client.user.avatarURL()}) 
            .setTimestamp()
          ...
          db.set(`${interaction.guild.id}.botRole`, role.id) 
